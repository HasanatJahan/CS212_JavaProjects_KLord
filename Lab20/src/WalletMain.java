...
public class WalletMain {
    ...
    /**
     * Method to add to wallet which will append new Money to the contents of the wallet
     */
    public static void addToWallet(Money m){

    }

    /**
     * Method to print values of all the bills and coins and wallets
     */

    /**
     * Method to return a String to show the calue of what's in the wallet in coin format
     */
